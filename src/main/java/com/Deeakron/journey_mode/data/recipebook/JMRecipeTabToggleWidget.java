...
public class JMRecipeTabToggleWidget extends ToggleWidget {
    private final JMRecipeBookCategories category;
    private float animationTime;

    public JMRecipeTabToggleWidget(JMRecipeBookCategories p_i51075_1_) {
        super(0, 0, 35, 27, false);
        this.category = p_i51075_1_;
        this.initTextureValues(153, 2, 35, 0, JMRecipeBookGui.RECIPE_BOOK);
    }

    public void startAnimation(Minecraft p_193918_1_) {
        EntityJourneyMode cap = p_193918_1_.player.getCapability(JMCapabilityProvider.INSTANCE,null).orElse(new EntityJourneyMode());
        JMRecipeBook clientrecipebook = cap.getRecipeBook();
    ...
    public JMRecipeBookCategories func_201503_d() {
        return this.category;
    }

    public boolean func_199500_a(JMRecipeBook p_199500_1_) {

...
public class AntikytheraRecipeItemList {
    ...
    private static boolean[] isShaped = {true, true, true, true, false, false, true, false, false, false, false, false, false, false, true, true, false, true, false, true, true, true, true, true, false, true};
